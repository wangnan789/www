...
function Lunar(){
 ...
 this.yueLiHTML=function(By,Bm,curJD){
  var sty_head =' style="font-family: 宋体; font-size: 14px; text-align: center; background-color: #F0F8FF; color: #000000; font-weight: bold" ';//星期1-7的颜色
  ...
  var sty_date2=' style="font-family: Arial Black; text-align: center;font-size: 20px; color: #FF00CC" ';//周末颜色--红色
  var sty_cur  =' style="background-color:#F0F8FF" ';//今天日期颜色
  ...
  var ta0='<tr><td colspan=7 style="background-color:#F0F8FF" >'+c+'</td></tr>'; //显示年号颜色
